...
export default function DownloadResources() {
    return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
            <h1 className="text-3xl font-bold text-gray-900 mb-6">Download Lesson Resources</h1>
                ...
                <div className="flex flex-col gap-4">
                    {resources.map((res) => (
                        <a
                            ...
                            href={res.href}
                            download
                            className="flex items-center justify-center bg-blue-600 text-white font-semibold py-3 rounded-md shadow hover:bg-blue-700 transition-colors border border-gray-100"
                        >
                            {res.icon}
                            {res.label}
                        </a>
